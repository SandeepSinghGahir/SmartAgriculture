...
class Light_sensor_sim ():
      ...
      def update_sensor(self):
          ...
          amplitude_distortion = (np.random.randint(1,20)/8)
          self.sensor_output = 35 - (abs(amplitude_distortion * 1e12) * np.sin(np.pi * float(total_time_elapsed)))
